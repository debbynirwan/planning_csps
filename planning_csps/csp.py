...
class CSP(Generic[V, D]):
    ...
    def backtracking_search(self, assignment=None) -> Optional[Dict[V, D]]:
        ...
        unassigned: List[V] = [v for v in self.variables if
                               v not in assignment]
...
if __name__ == "__main__":
    ...
    csp.add_constraint(
        MapColoringConstraint("Queensland", "South Australia"))
    csp.add_constraint(
        MapColoringConstraint("Queensland", "New South Wales"))
    csp.add_constraint(
        MapColoringConstraint("New South Wales", "South Australia"))
    csp.add_constraint(
        MapColoringConstraint("Victoria", "South Australia"))
    csp.add_constraint(
        MapColoringConstraint("Victoria", "New South Wales"))
    csp.add_constraint(
